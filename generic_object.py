...
class GenericObject(PublisherMixin, metaclass=GenericMeta):  
    ...
    _ATTRIBUTES:
        ...
        * 14/6/2019: The least 4 above are moving to _get_pg_properties function.
    ...
    def find_attribute(self, key):
        """
        Find a attribute inside _ATTRIBUTES structure.
        """
        return self._ATTRIBUTES.get(key, None)
            

    def get_state(self):
        #print('\nGenericObject.get_state:', self.uid, self._ATTRIBUTES.keys())
        state = OrderedDict()
